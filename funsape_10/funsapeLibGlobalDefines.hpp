...
enum class Error : cuint16_t {
    ...
    ASF608_NO_FINGER                                    = 0x0201,   // FINGERPRINT_NOFINGER if no finger detected
    ASF608_PACKET_RECEIVER_ERROR                        = 0x0202,   // FINGERPRINT_PACKETRECIEVEERR on communication error
    ASF608_IMAGE_ERROR                                  = 0x0203,   // FINGERPRINT_IMAGEFAIL on imaging error
    ASF608_IMAGE_MESSY                                  = 0x0204,   // FINGERPRINT_IMAGEMESS if image is too messy
    ASF608_IMAGE_INVALID                                = 0x0205,   // FINGERPRINT_INVALIDIMAGE on failure to identify fingerprint features
    ASF608_FEATURE_FAILED                               = 0x0206,   // FINGERPRINT_FEATUREFAIL on failure to identify fingerprint features
    ASF608_NOT_FOUND                                    = 0x0207,   // FINGERPRINT_NOTFOUND if no match is made
    ASF608_BAD_PACKET                                   = 0x0208,   // FINGERPRINT_BADPACKET
