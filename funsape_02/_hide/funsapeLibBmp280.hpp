...
#ifndef __FUNSAPE_LIB_BMP280_HPP
#define __FUNSAPE_LIB_BMP280_HPP                        2407
...
#elif __FUNSAPE_LIB_GLOBAL_DEFINES_HPP != __FUNSAPE_LIB_BMP280_HPP
...
#elif __FUNSAPE_LIB_DEBUG_HPP != __FUNSAPE_LIB_BMP280_HPP
...
#elif __FUNSAPE_LIB_BUS_HPP != __FUNSAPE_LIB_BMP280_HPP
...
public:
    ...
    enum class StandbyTime : uint8_t {
        ...
        STANDBY_2_S                     = 6,    // 2 s between measurements
        STANDBY_4_S                     = 7,    // 4 s between measurements
    };
...
public:
    ...
    //!
    //! \brief      Bmp280 class constructor
    //! \details    Creates a Bmp280 object.
    //!
    Bmp280(
            void
    );
    ...
    //!
    //! \brief      Bmp280 class destructor
    //! \details    Destroys a Bmp280 object.
    //!
    ~Bmp280(
            void
    );
...
public:
    ...
    //!                 address is responding. Since the BMP280 has an internal
    //!                 register to store it's device (or part) ID, this
    //!                 register is also checked to ensure the device is
    //!                 actually a BMP280 device. The busOption_p flag value
...
#endif  // __FUNSAPE_LIB_BMP280_HPP

// =============================================================================
// END OF FILE - funsapeLibBmp280.hpp
// =============================================================================
